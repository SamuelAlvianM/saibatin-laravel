...
return [
    ...
    */
    ...
    'options' => [
         ...
         *
         * 🔴 DINYALAKAN (bawaannya false). Tanpa ini dompdf menyematkan berkas
         * font DejaVu Sans UTUH ke setiap PDF — satu lembar tanda terima
         * permohonan jadi **873 KB**, dan hampir seluruhnya glyph yang tidak
         * pernah dipakai (Cyrillic, Yunani, Arab). Dengan subset hanya karakter
         * yang benar-benar muncul yang ikut. Diukur 17 Agu 2026: 873 KB → 30 KB.
         *
         * ⚠️ Kalau suatu saat PDF-nya menampilkan kotak kosong menggantikan
         * huruf, tersangka pertamanya baris ini — bukan CSS-nya.
         */
